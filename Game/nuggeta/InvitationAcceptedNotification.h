#ifndef _INVITATIONACCEPTEDNOTIFICATION
#define _INVITATIONACCEPTEDNOTIFICATION
#include "Message.h"
#include <cstring>
...
class InvitationAcceptedNotification :public  Message {
    public:
    ...
    public:
        virtual ~InvitationAcceptedNotification();
};
#endif // _INVITATIONACCEPTEDNOTIFICATION